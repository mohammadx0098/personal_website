...
JWT_AUTH = {
    "JWT_GET_USER_SECRET_KEY": "personal_website.authentication.services.auth_user_get_jwt_secret_key",
    "JWT_RESPONSE_PAYLOAD_HANDLER": "personal_website.authentication.services.auth_jwt_response_payload_handler",
